...
import com.example.floation.guestMenu.GuestScreen;
...
public class LoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuest.setOnClickListener(onLogin);
    }
    ...
    View.OnClickListener onLogin = onClick -> {
        ...
        if(onClick.getId() == R.id.buttonGuest){
            nextIntent = new Intent(LoginPage.this, GuestScreen.class);
            startActivity(nextIntent);
        }
    };
